...
- (void)drawRect:(CGRect)rect {
    ...
    //    UIView *view =[UIView alloc]initWithFrame:CGRectFromString(<#NSString *string#>)
    
    CGRect dividerViewRect=CGRectMake(frameSize.width-0.5, 0, 0.5, frameSize.height);
    UIView *dividerView=[[UIView alloc]initWithFrame:dividerViewRect];
