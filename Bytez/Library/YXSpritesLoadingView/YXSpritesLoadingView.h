...
#define cycleAnimationDuration 0.4
#define animationImageWidth 75
#define animationImageHeight 75
#define numberOfFramesInAnimation 11
#define spriteNameString @"bat_"
...
#define loadingTextFontName @"GillSans-Bold"
#define loadingTextFontSize 15
#define loadingTextColor [UIColor colorWithRed:236.0/255.0 green:84.0/255.0 blue:92.0/255.0 alpha:1.000]
